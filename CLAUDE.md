...
This project is indexed by GitNexus as **job-tracker** (1870 symbols, 4962 relationships, 144 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
