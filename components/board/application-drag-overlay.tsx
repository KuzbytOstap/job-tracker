...
export function ApplicationDragOverlay({ application }: ApplicationDragOverlayProps) {
  ...
  return (
    <DragOverlay dropAnimation={prefersReducedMotion ? null : defaultDropAnimation}>
      {application ? (
        <div className="kanban-drag-overlay w-[260px] scale-[1.02] rotate-[-1.25deg] rounded-xl border border-border bg-card p-3 shadow-lg shadow-black/10 motion-reduce:scale-100 motion-reduce:rotate-0 dark:shadow-black/40">
