...
export function FocusedStatusView({ slug }: FocusedStatusViewProps) {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-background">
      ...
      <div className="mx-auto w-full max-w-[760px] px-4 pt-4 pb-24 sm:px-6 sm:pb-16">
        <Link
          href="/"
        ...
        <div className="mb-4 flex items-center gap-2">
          ...
          <h1 className="font-heading text-lg font-semibold tracking-tight">{column.label}</h1>
          {typeof count === "number" && (
